...
p "Seeding promos"
PRODUCTS = [
  { name: 'Hello', description: 'hellooo', price_in_cents: 179, picture: 'https://cdn.shopify.com/s/files/1/0377/2037/products/GunmetalSandstoneLeather.Front.EDIT_1024x.jpg?v=1510684261'},
  ...
  { name: 'Watch 3', description: 'Watch description 3', price_in_cents: 99, picture: 'https://ae01.alicdn.com/kf/HTB1Xc.5PVXXXXbgaVXXq6xXFXXXC/NO-LOGO-classic-Elite-Watch-Men-Women-Simple-Stable-Pointer-Clock-Fashion-Interview-White-Collar-Wrist.jpg_640x640.jpg'},
  ...
  { name: 'Watch 7', description: 'Watch description 7', price_in_cents: 99, picture: 'https://cdn.shopify.com/s/files/1/0377/2037/products/WhiteTanLeather.Front_1024x1024.jpg?v=1510683461'},
  { name: 'Watch 8', description: 'Watch description 8', price_in_cents: 99, picture: 'https://cdn.shopify.com/s/files/1/0377/2037/products/Voyager08.Front_1024x1024.jpg?v=1510685016' },
  { name: 'Watch 9', description: 'Watch description 9', price_in_cents: 99, picture: 'https://cdn.shopify.com/s/files/1/0377/2037/products/Womens14.Front_1024x.jpg?v=1510688045'},
